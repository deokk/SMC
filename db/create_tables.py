...
def create_tables():
    ...
    try:
        ...
        # Drop tables defined via declarative_base first (User)
        Base.metadata.drop_all(engine)

        # Drop tables defined via MetaData
        metadata.drop_all(engine) # Drops all tables in this metadata object
        ...
        print("Tables 'bike_availability_realtime', 'bike_availability_historical', 'users', 'stations_gwangjin', 'transit_stops' created successfully.")
